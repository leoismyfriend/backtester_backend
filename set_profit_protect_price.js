...
const pppo = set_protect_price_offset(300,20,10,40,5000)
console.log('pppo: ', pppo)

function set_protect_price_offset(size, profit_protect_price, basis_price, event_risk_buffer, pnl_change){
...
module.exports = set_protect_price_offset
