async function set_initial_trade_object(user_input){
    ...
    trade_info.profit_protect_price = trade_info.basis - user_input.protect_buffer_runway
    trade_info.pnl_chg = 0 
    trade_info.sum_pnl = 0 
    trade_info.profit_protect_pnl_level = trade_info.sum_pnl - trade_info.size * (trade_info.trade_price - trade_info.protect_buffer_runway)      
